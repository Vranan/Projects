...
for table_row in soup.select(".inmatesList tr"):
	...
	#print("table_cells_________td________")
	#print(table_cells)
	...
	if len(table_cells) > 0:
		...
		#print("absolute_link_to_inmate_details = ",absolute_link_to_inmate_details)
